...
class JDWrapper(object):
    ...
    def good_stock(self, stock_id, good_count=1, area_id=None):
        ...
        payload = {
            'type' : 'getstocks',
            'skuIds' : str(stock_id),
            'area' : area_id or '19_1601_3633_0', # area change as needed
        }
    ...
    def buy_good_count(self, good_id, count):
        ...
        payload = {
            ...
            'locationId':'19_1601_3633_0',  # need changed to your area location id
        }
    ...
    def order_info(self, submit=False):
        ...
        try:
            order_url = 'https://trade.jd.com/shopping/order/getOrderInfo.action'
            payload1 = {
                'rid' : str(int(time.time() * 1000)),
            }

            # get preorder page
            rs = self.sess.get(order_url, params=payload1, cookies = self.cookies)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-a', '--area',
                        help='Area string, like: 1_72_2799_0 for guangzhou t h', default='19_1601_3633_0')
